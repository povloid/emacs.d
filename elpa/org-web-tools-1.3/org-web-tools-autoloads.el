...
\(fn URL &key (CAPTURE-FUNCTION #\\='org-web-tools--url-as-readable-org))" t nil)
...
\(fn URL &key (SHOW-BUFFER-FUNCTION #\\='switch-to-buffer))" t nil)
...
\(fn URL &optional CHOOSE-FN-P VIEW)" t nil)
